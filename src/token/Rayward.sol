...
contract Rayward is ERC20Capped, ERC20Permit, AccessControl {
    ...
    uint256 public constant MAX_SUPPLY = 13700000000 * (10**uint256(18));

    constructor(address _admin) ERC20("Rayward", "RAYWARD") ERC20Capped(MAX_SUPPLY) ERC20Permit("Rayward"){
